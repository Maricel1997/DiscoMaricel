CREATE DATABASE  IF NOT EXISTS `disco` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `disco`;
...
CREATE TABLE `discos` (
  ...
  `formato` varchar(50) COLLATE utf8mb4_bin NOT NULL,
  `genero` varchar(50) COLLATE utf8mb4_bin NOT NULL,
  `duracion` varchar(50) COLLATE utf8mb4_bin NOT NULL,
...
INSERT INTO `discos` VALUES (1,'Redes','mp3','clasico','15','Maricel'),(2,'Maricel','mp3','clasico','20','M');
...
-- Dump completed on 2023-06-07 20:48:41
